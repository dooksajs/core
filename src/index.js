export default {
  ...
  methods: {
    getList (context, { collection, page = 1, perPage = 25, options = {} }) {
      return new Promise((resolve, reject) => {
    ...
    getOne (context, { collection, id, options = {} }) {
      return new Promise((resolve, reject) => {
    ...
    create (context, { collection, data, options = {} }) {
      // add a modal check
      return new Promise((resolve, reject) => {
    ...
    update (context, { collection, id, data }) {
      // add a modal check
      return new Promise((resolve, reject) => {
