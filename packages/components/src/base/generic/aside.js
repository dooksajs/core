...
/**
 * @typedef {Object} ExtendAsideOptions
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @typedef {Object} ExtendAsideEvent
 * @property {EventTypeMouseMixin | EventTypeElementDragDropMixin | EventTypeTouchMixin | ComponentEventOn} on
 * @property {string} actionId
 */

/**
 * @typedef {Object} ExtendAsideEventMixin
 * @property {ExtendAsideEvent[]} [events]
 */

/**
 * @typedef {ComponentExtend
 *   & ExtendAsideOptions
 *   | ExtendAsideEventMixin
 * } ExtendAside
 */

/**
 * @param {ExtendAside} options -
 */
export const createAside = function (options) {
  return extendComponent(aside, options)
}
