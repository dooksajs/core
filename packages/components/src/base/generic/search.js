...
/**
 * @typedef {Object} ExtendSearchOptions
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @typedef {Object} ExtendSearchEvent
 * @property {EventTypeMouseMixin | EventTypeElementDragDropMixin | EventTypeTouchMixin | ComponentEventOn} on
 * @property {string} actionId
 */

/**
 * @typedef {Object} ExtendSearchEventMixin
 * @property {ExtendSearchEvent[]} [events]
 */

/**
 * @typedef {ComponentExtend
 *   & ExtendSearchOptions
 *   | ExtendSearchEventMixin
 * } ExtendSearch
 */

/**
 * @param {ExtendSearch} options -
 */
export const createSearch = function (options) {
  return extendComponent(search, options)
}
