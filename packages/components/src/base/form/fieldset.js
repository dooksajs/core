...
import { borderMixin, displayMixin, gapMixin, idMixin, roundedMixin, spacingMixin } from '@dooksa/components/mixins'
...
/**
 * @import {IdMixin, SpacingMixin, BorderMixin, RoundedMixin, DisplayMixin, GapMixin} from '@dooksa/components/mixins'
