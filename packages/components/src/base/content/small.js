...
/**
 * @typedef {Object} ExtendSmallEvent
 * @property {EventTypeMouseMixin | EventTypeElementDragDropMixin | EventTypeTouchMixin | ComponentEventOn} on
 * @property {string} actionId
 */

/**
 * @typedef {Object} ExtendSmallEventMixin
 * @property {ExtendSmallEvent[]} [events]
 */

/**
 * @typedef {ComponentExtend & ExtendSmallOptionMixin | ExtendSmallEventMixin} ExtendSmall
 */
