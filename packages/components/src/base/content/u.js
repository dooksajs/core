...
export const u = createComponent({
  id: 'u',
  tag: 'u'
}, [
  backgroundMixin,
...
/**
 * @param {ExtendU} options -
 */
export const createU = function (options) {
  return extendComponent(u, options)
}
