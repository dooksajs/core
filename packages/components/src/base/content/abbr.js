...
/**
 * @typedef {Object} ExtendAbbrOptions
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @typedef {Object} ExtendAbbrEvent
 * @property {EventTypeMouseMixin | EventTypeElementDragDropMixin | EventTypeTouchMixin | ComponentEventOn} on
 * @property {string} actionId
 */

/**
 * @typedef {Object} ExtendAbbrEventMixin
 * @property {ExtendAbbrEvent[]} [events]
 */

/**
 * @typedef {ComponentExtend
 *   & ExtendAbbrOptions
 *   | ExtendAbbrEventMixin
 * } ExtendAbbr
 */

/**
 * @param {ExtendAbbr} options -
 */
export const createAbbr = function (options) {
  return extendComponent(abbr, options)
}
