...
/**
 * @typedef {Object} ExtendSubOptions
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @param {ExtendSub} options -
 */
export const createSub = function (options) {
  return extendComponent(sub, options)
}
