...
/**
 * @typedef {Object} ExtendStrongOptions
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @typedef {Object} ExtendStrongEvent
 * @property {EventTypeMouseMixin | EventTypeElementDragDropMixin | EventTypeTouchMixin | ComponentEventOn} on
 * @property {string} actionId
 */

/**
 * @typedef {Object} ExtendStrongEventMixin
 * @property {ExtendStrongEvent[]} [events]
 */

/**
 * @typedef {ComponentExtend
 *   & ExtendStrongOptions
 *   | ExtendStrongEventMixin
 * } ExtendStrong
 */

/**
 * @param {ExtendStrong} options -
 */
export const createStrong = function (options) {
  return extendComponent(strong, options)
}
