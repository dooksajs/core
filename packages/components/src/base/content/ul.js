...
/**
 * @typedef {Object} ExtendUlOptions
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @param {ExtendUl} options -
 */
export const createUl = function (options) {
  return extendComponent(ul, options)
}
