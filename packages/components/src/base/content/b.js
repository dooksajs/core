...
export const b = createComponent({
  id: 'b',
  tag: 'b'
}, [
  backgroundMixin,
...
/**
 * @param {ExtendB} options -
 */
export const createB = function (options) {
  return extendComponent(b, options)
}
