...
/**
 * @typedef {Object} ExtendBdiOptions
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @param {ExtendBdi} options -
 */
export const createBdi = function (options) {
  return extendComponent(bdi, options)
}
