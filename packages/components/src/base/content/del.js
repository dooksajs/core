...
/**
 * @typedef {Object} ExtendDelOptions
...
/**
 * @param {ExtendDel} options -
 */
export const createDel = function (options) {
  return extendComponent(del, options)
}
