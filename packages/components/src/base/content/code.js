...
/**
 * @typedef {Object} ExtendCodeOption
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @typedef {Object} ExtendCodeEvent
 * @property {EventTypeMouseMixin | EventTypeElementDragDropMixin | EventTypeTouchMixin | ComponentEventOn} on
 * @property {string} actionId
 */

/**
 * @typedef {Object} ExtendCodeEventMixin
 * @property {ExtendCodeEvent[]} [events]
 */

/**
 * @typedef {ComponentExtend & ExtendCodeOption | ExtendCodeEventMixin} ExtendCode
 */
