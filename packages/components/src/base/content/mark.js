...
/**
 * @typedef {Object} ExtendMarkOptions
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @typedef {Object} ExtendMarkEvent
 * @property {EventTypeMouseMixin | EventTypeElementDragDropMixin | EventTypeTouchMixin | ComponentEventOn} on
 * @property {string} actionId
 */

/**
 * @typedef {Object} ExtendMarkEventMixin
 * @property {ExtendMarkEvent[]} [events]
 */

/**
 * @typedef {ComponentExtend
 *   & ExtendMarkOptions
 *   | ExtendMarkEventMixin
 * } ExtendMark
 */

/**
 * @param {ExtendMark} options -
 */
export const createMark = function (options) {
  return extendComponent(mark, options)
}
