...
export const i = createComponent({
  id: 'i',
  tag: 'i'
}, [
  backgroundMixin,
...
/**
 * @param {ExtendI} options -
 */
export const createI = function (options) {
  return extendComponent(i, options)
}
