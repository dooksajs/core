...
/**
 * @typedef {Object} ExtendKbdOptions
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @param {ExtendKbd} options -
 */
export const createKbd = function (options) {
  return extendComponent(kbd, options)
}
