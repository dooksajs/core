...
/**
 * @typedef {Object} ExtendOlOptions
 * @property {FontMixin
 *   | RoundedMixin
 *   | ShadowMixin
 *   | BackgroundMixin
...
/**
 * @param {ExtendOl} options -
 */
export const createOl = function (options) {
  return extendComponent(ol, options)
}
