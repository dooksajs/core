...
/**
 * @typedef {Object} ExtendTimeOptions
...
/**
 * @typedef {Object} ExtendTimeEvent
 * @property {EventTypeMouseMixin | EventTypeElementDragDropMixin | EventTypeTouchMixin | ComponentEventOn} on
 * @property {string} actionId
 */

/**
 * @typedef {Object} ExtendTimeEventMixin
 * @property {ExtendTimeEvent[]} [events]
 */

/**
 * @typedef {ComponentExtend
 *   & ExtendTimeOptions
 *   | ExtendTimeEventMixin
 * } ExtendTime
 */

/**
 * @param {ExtendTime} options -
 */
export const createTime = function (options) {
  return extendComponent(time, options)
}
