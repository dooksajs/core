...
describe('Fetch plugin', function () {
  ...
  beforeEach(async function (t) {
    ...
    // Setup fetch plugin with mock server URL
  ...
  describe('getById action', function () {
    it('should fetch single document by ID', async function () {
      const result = await mock.client.method.fetchGetById({
        collection: 'user/profiles',
        id: 'user-1'
      })
    ...
    it('should sync data to state by default', async function () {
      await mock.client.method.fetchGetById({
        collection: 'user/profiles',
        id: 'user-2'
      })
  ...
  describe('Caching behavior', function () {
    it('should return cached data on second request', async function () {
      ...
      const result1 = await mock.client.method.fetchGetAll({
        collection: 'user/profiles'
      })
      ...
      const result2 = await mock.client.method.fetchGetAll({
        collection: 'user/profiles'
      })
  ...
  describe('Request queue management', function () {
    it('should handle duplicate concurrent requests', async function () {
      ...
      const promises = [
        mock.client.method.fetchGetAll({ collection: 'user/profiles' }),
        mock.client.method.fetchGetAll({ collection: 'user/profiles' }),
        mock.client.method.fetchGetAll({ collection: 'user/profiles' })
      ]
    ...
    it('should handle concurrent requests to different resources', async function () {
      ...
      const promises = [
        mock.client.method.fetchGetAll({ collection: 'user/profiles' }),
        mock.client.method.fetchGetAll({ collection: 'other/collection' })
      ]
  ...
  describe('Plugin metadata and exports', function () {
    it('should have correct plugin metadata', function () {
      // Verify fetch plugin is properly mocked
      ok(mock.client.method.fetchGetAll)
      ok(mock.client.method.fetchGetById)
      strictEqual(typeof mock.client.method.fetchGetAll, 'function')
      strictEqual(typeof mock.client.method.fetchGetById, 'function')
    })

    it('should have setup function available', function () {
      // Verify setup is accessible
      ok(mock.client.setup.fetch)
      strictEqual(typeof mock.client.setup.fetch, 'function')
    })
  ...
  describe('Performance and edge cases', function () {
    it('should handle rapid successive calls efficiently', async function () {
      ...
      for (let i = 0; i < 10; i++) {
        promises.push(mock.client.method.fetchGetAll({
          collection: 'user/profiles'
        }))
      }
